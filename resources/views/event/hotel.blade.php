...
@section('sidebar')
    ...
    <section>
        ...
        <p>When booking your room at the University Inn, be sure to use the promotional code PNWPHPISAWESOME to access our reserved block of rooms and benefit from the discounted price.</p>
        <footer>
